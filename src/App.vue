...
<template>
  ...
  <div>
    ...
    <input v-model="newUlam.imageURL" type="text" placeholder="Ulam Image Link"/>
    <input v-model="newUlam.ytLink" type="text" placeholder="Ulam YT video Link"/>
  ...
  <div v-for="ulam in ulams" class="card">
    ...
    <div class="card-body">
      ...
      <p>Click <a :href="ulam.ytLink" target="_blank">here</a> for the tutorial.</p>
    </div>
